...
<h3 align="center">Policy Systems Analyst</h3>

---

- I am an Economic and Policy Analyst working on actionable knowledge at system-level governance, and data-informed policy insights. My work focuses on the analysis of complex socio-economic ecosystems and the use of data-driven approaches to support policy design, implementation, and strategic decision-making at EU and local levels.

- 🔍 Check out one of my latest contributions:  
  <strong>
    <a href="https://youtu.be/0U72u8hUrNc">
      Self-Assessment Tool for Knowledge Valorisation in Quadruple Helix Environments
    </a>
  </strong>  
  <em>(KALEIDOS Project – EU)</em> where I delve into knowledge valorisation in Quadruple Helix contexts.
...
- 💼 Access my online portfolio <a href="PORTFOLIO_LINK">here</a> for an overview of my work, or explore the repositories below for detailed analytical and technical outputs.
